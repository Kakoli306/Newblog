            ...
            <form class="form-horizontal" method="POST" action="{{ url('/editPost',array($posts->id)) }}" enctype="multipart/form-data">
              ...
              <div class="form-group{{ $errors->has('post_title') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  ...
                  value="{{ $posts->post_title }}" required autofocus>
              ...
              <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  <textarea id="post_body" rows="7" type="post_body" class="form-control" name="post_body"
                             required>{{ $posts->post_body }}</textarea>
