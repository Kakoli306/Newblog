        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-5 sidebar">
                ...
                <div class="widget-item">
                    ...
                    <ul class="instagram">
                        <li><img src="{{asset('public/frontEnd/') }}/img/instagram/1.jpg" alt=""></li>
                        <li><img src="{{asset('public/frontEnd/') }}/img/instagram/2.jpg" alt=""></li>
                        <li><img src="{{asset('public/frontEnd/') }}/img/instagram/3.jpg" alt=""></li>
                        <li><img src="{{asset('public/frontEnd/') }}/img/instagram/4.jpg" alt=""></li>
                        <li><img src="{{asset('public/frontEnd/') }}/img/instagram/5.jpg" alt=""></li>
                        <li><img src="{{asset('public/frontEnd/') }}/img/instagram/6.jpg" alt=""></li>
                    </ul>
                </div>
                <!-- Single widget -->
                <div class="widget-item">
                ...
                <div class="widget-item">
                    ...
                    <div class="add">
                        <a href=""><img src="{{asset('public/frontEnd/') }}/img/add.jpg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
